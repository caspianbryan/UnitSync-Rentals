...
// Custom Clerk sign-in page with UnitSync theme
// ============================================================
...
export default function SignInPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0F] flex items-center justify-center p-4">
      ...
      {/* Gradient orbs */}
      <div className="fixed top-0 right-0 w-96 h-96 bg-blue-500/10 dark:bg-blue-500/5 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-0 left-0 w-80 h-80 bg-[#D4AF37]/10 dark:bg-[#D4AF37]/5 rounded-full blur-3xl pointer-events-none" />
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                identityPreviewEditButton: "text-[#D4AF37] hover:text-[#c9a634]",
